...
def dataPrepare():
    ...
    from ad_resize import resize_image
    train_images_resized, val_images_resized, test_images_resized=resize_image(train_images,val_images,test_images)

    return train_images,train_labels,val_images,val_labels,test_images,test_labels,train_images_normalized,val_images_normalized,test_images_normalized,train_images_resized, val_images_resized, test_images_resized
